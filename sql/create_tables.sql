...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MKR"."VOXB_ITEMS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 152267 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOXB_LOCALS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MKR"."VOXB_LOCALS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 260 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOXB_LOGS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MKR"."VOXB_LOGS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 452692 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOXB_OBJECTS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MKR"."VOXB_OBJECTS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 83433 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOXB_REVIEWS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MKR"."VOXB_REVIEWS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 44882 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOXB_STATISTICS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MKR"."VOXB_STATISTICS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1991081 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MKR"."VOXB_USERS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 18044 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "MKR"."VOXB_STATISTICS" 
   (	"COUNT" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "MKR"."VOXB_STATISTICS_PK" ON "MKR"."VOXB_STATISTICS" ("METHOD", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "ERROR", "CREATION_DATE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "MKR"."VOXB_STATISTICS" ADD CONSTRAINT "VOXB_STATISTICS_PK" PRIMARY KEY ("METHOD", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "ERROR", "CREATION_DATE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DEVELOPER_TS"  ENABLE;
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("CREATION_DATE" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("ERROR" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P7" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P6" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P5" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P4" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P3" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P2" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("P1" NOT NULL ENABLE);
  ALTER TABLE "MKR"."VOXB_STATISTICS" MODIFY ("METHOD" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MKR"."VOXB_COMPLAINTS" ADD CONSTRAINT "REF_OFF_INSTITUTIONID" FOREIGN KEY ("OFFENDER_INSTITUTIONID")
	  REFERENCES "MKR"."VOXB_INSTITUTIONS" ("INSTITUTIONID") ON DELETE CASCADE ENABLE;
